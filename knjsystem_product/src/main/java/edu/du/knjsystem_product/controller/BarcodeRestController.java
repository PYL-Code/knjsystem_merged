...
public class BarcodeRestController {
    ...
    @GetMapping("/detail")
    public ResponseEntity<BarcodeDetailDto> getBarcodeDetail(@RequestParam("barcodeId") Long barcodeId) {
//        System.out.println("✅ 조회 요청 받은 barcodeId: " + barcodeId);
    ...
    public ResponseEntity<String> updateCertInfo(@RequestParam("certId") Long certId,
                                                 @RequestParam("barcodeId") Long barcodeId,
    ...
    public ResponseEntity<String> deleteBarcodeCert(@RequestParam("barcodeId") Long barcodeId,
                                                    @RequestParam("barcodeNo") String barcodeNo,
